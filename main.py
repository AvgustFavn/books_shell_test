...
def main() -> None:
    """
        Главная функция, которая запускает интерактивное меню.

        Данная функция представляет собой цикл, в котором пользователь может выбирать различные действия:
        1. Добавить книгу
        2. Удалить книгу
        3. Найти книгу
        ...
        В зависимости от выбора, выполняются соответствующие функции.
